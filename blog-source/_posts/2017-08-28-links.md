...
The bar for making this list is high. I only selected articles in areas in which I have some background in, so as to be able to distinguish the good writing and ideas from the exceptional. Organized roughly in order of general applicability:
...
- Hotmail and the email signature...
