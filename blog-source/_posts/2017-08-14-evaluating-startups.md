...
*This blog post is based on my experience interviewing with a range of tech companies during my junior year at Princeton. At the end of the process, I was fortunate to have the choice between a [large public company](https://www.google.com/), a then recently-minted [unicorn](https://en.wikipedia.org/wiki/Unicorn_(finance)), and a then-Series B startup with 100 employees based in San Francisco.*
