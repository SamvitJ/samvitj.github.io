...
Here's a weird example: if I attended Stanford, I might regret *not* trying to start a company (many of my peers tried to start one, and some of them succeeded). If I went to any other university in the world, I might regret not staying in my great job.
