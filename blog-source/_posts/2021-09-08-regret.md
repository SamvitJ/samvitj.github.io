...
1. Should I move to a new country?

2. Should I choose job opportunity X or job opportunity Y?

3. Should I get a graduate degree (e.g., a PhD, an MBA, etc.)?

4. Should I move across the country to do X?

5. Should I pursue a non-traditional career path? (become a writer, start a business, ...)

6. Should I commit to building a future with this person?

According to regret minimization, we should project ourselves into the future and consider which path we would regret not taking more. Will I regret not moving for that job opportunity I once had? Will I always regret that I didn't get a PhD? Will I regret not marrying them?
...
But if my career is mediocre, I could have many regrets. Why didn't I join company X? Why didn't I move? Why didn't I get an MBA? Why didn't I pivot to doing Y?
...
For me, one life invariant has been my desire to be (at least somewhat) successful. I have been an overachiever since I was five years old, and though this has tempered over time, caring about the outcome is a core part of who I am. I just wouldn't be content dabbling in obscurity on a weird personal passion as my main job. So this gives me a good test for thinking about important life decisions. What choices increase the likelihood of achieving at least baseline success in an endeavor?

(This is partially why I have qualms with the original framing of regret minimization. "I knew that if I failed, I wouldn’t regret that" is, for many people, not always true in practice!)

Another set of invariants might be core interests. Since elementary school, I have enjoyed math, writing, and strategy games, so choices that involve (or put me closer to) working with logic and numbers, producing prose, or making analytical decisions in a competitive context get precedence over choices that optimize for some temporary objective.
