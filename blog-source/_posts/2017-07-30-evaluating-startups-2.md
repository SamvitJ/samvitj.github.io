...
An example of a startup with a boring-sounding mission statement that does very interesting work (and, incidentally, scores highly on all of the other criteria) is Samsara. Here's a description from their [About](https://www.samsara.com/about) page:
...
Started by the two MIT PhD dropouts who co-founded Meraki, an enterprise Wi-Fi networking startup acquired by Cisco for $1.2 billion, and staffed by an exceptional [team](https://www.samsara.com/team), Samsara is building tools to visualize and execute queries on large streams of machine-generated data - data, for example, emanating from fleets of sensors installed on transportation networks. Samsara is a textbook example of a team with deep domain expertise tackling an immense, emerging market. Even if you don't give a hoot about sensors, their work - which touches on a variety of areas, including data science, real-time systems, and machine learning - could represent an interesting opportunity.
